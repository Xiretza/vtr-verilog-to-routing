...
VNumber V_LT(VNumber& a, VNumber& b) {
    ...
    BitSpace::bit_value_t result = cmp.is_unk()  ? BitSpace::_x
                                   : cmp.is_lt() ? BitSpace::_1
                                                 : BitSpace::_0;
